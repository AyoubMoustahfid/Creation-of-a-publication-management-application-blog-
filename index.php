    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-12 col-xl-6">
       <div class="card"style=" border:none;" >
          <img src="uploads/card1.png" class="card-img-top" alt="..." height="500" width="273">
          <div class="card-body">
            <h3 class="card-title">How to optimize your Facebook & Instagram video ads for succes</h3>
           ...
           <div class="row no-gutters">
              ...
              <div class="col-md-8">
                 <div class="card-body">
                     ...
                     <p class="card-text">I’m Programming on a Macbook and Here Are the Tools That Make My Life Easier.</p>
